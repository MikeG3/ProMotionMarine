document.addEventListener("DOMContentLoaded", () => {
    ...
    const cameraImages =
        document.querySelectorAll(".camera-gallery img");

    const cameraLightbox =
        document.getElementById("camera-lightbox");

    const cameraLightboxImg =
        document.getElementById("camera-lightbox-img");
